...
styles.header  = { fg_color = beautiful.accent,
    bg_color = "#00000000",
    markup   = function(t) return '<span font_desc="sans bold 16">' .. t .. '</span>' end,
}
styles.weekday = { fg_color = beautiful.accent_2,
    bg_color = "#00000000",
    padding  = 3,
    markup   = function(t) return '<b>' .. t .. '</b>' end,
}
local function decorate_cell(widget, flag, date)
    ...
    local default_fg = beautiful.fg_color
    local default_bg = beautiful.bg_color
